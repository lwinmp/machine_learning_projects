"""
Restaurant Recommendation System — Utility Functions
Collaborative filtering on the UCI Restaurant & Consumer explicit-rating dataset (rating scale 0-2).
...
UCOL, ICOL, RCOL = "userID", "placeID", "rating"
...
def load_ratings(path="data/rating_final.csv"):
...
def load_items(path="data/geoplaces2.csv", id_col="placeID", name_col="name"):
